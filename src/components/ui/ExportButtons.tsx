...
export default function ExportButtons() {
  ...
  const handleExportPNG = async () => {
    ...
    try {
      // Determine if we're in light or dark mode to set background properly
  ...
  return (
    <div className="flex gap-2">
      ...
      <button
        ...
        className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl bg-blue-100 dark:bg-blue-600/20 text-blue-700 dark:text-blue-400 border border-blue-300 dark:border-blue-600/30 hover:bg-blue-200 dark:hover:bg-blue-600/30 transition-colors text-sm font-medium"
      >
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
